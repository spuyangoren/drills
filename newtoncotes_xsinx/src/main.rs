...
fn main() {
   ...
   // let a = -1.0;
    ...
    println!("sinx: trapezoid rule: {}", result_trapezoid);
    println!("sinx: simpsons rule: {}", result_simpsons);
    println!("sinx: simpsons rule: {}", result_simpsons38);
    println!("sinx: booles rule: {}", result_booles);
